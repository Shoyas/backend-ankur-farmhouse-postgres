...
const getAllServicesByCategoryId = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_service_1.CategoryService.getAllServicesByCategoryId(req.params.id, req.query // You can pass the query parameters directly for pagination
    );
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
